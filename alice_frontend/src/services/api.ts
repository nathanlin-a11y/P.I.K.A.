...
import { PIKAChat, convertToPIKAChat, MessageType } from '../types/ChatTypes';
...
export const addTaskResponse = async (chatId: string, taskResultId: string): Promise<PIKAChat> => {
  try {
