...
import { MessageType, PIKAChat, PIKAAgent, CreatePIKAChat } from '../utils/types';
...
interface ChatContextType {
    ...
    createNewChat: (chatData: Partial<CreatePIKAChat>) => Promise<string>;
...
export const ChatProvider: React.FC<ChatProviderProps> = ({ children }) => {
    ...
    const createNewChat = async (chatData: Partial<CreatePIKAChat>): Promise<string> => {
        try {
