...
const Database: React.FC = () => {
    ...
    const handleItemSelect = useCallback((item: PIKAAgent | PIKAModel | ParameterDefinition | Prompt | PIKATask | TaskResponse | PIKAChat | API) => {
    ...
    const handleSave = useCallback(async (item: PIKAAgent | PIKAModel | ParameterDefinition | Prompt | PIKATask | TaskResponse | PIKAChat | API) => {
