...
const EnhancedCardDialog: React.FC = () => {
  ...
  const renderDialogContent = () => {
    ...
    const handleProps = {
      handleAgentClick: (id: string, item?: PIKAAgent) => selectItem('Agent', id, item),
      handleTaskClick: (id: string, item?: PIKATask) => selectItem('Task', id, item),
      handleModelClick: (id: string, item?: PIKAModel) => selectItem('Model', id, item),
