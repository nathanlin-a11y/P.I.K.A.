...
import { PIKATask, TaskComponentProps, TaskType, getDefaultTaskForm } from '../../../../utils/TaskTypes';
...
const TaskFlexibleView: React.FC<TaskComponentProps> = ({
    ...
    const [form, setForm] = useState<PIKATask>(getDefaultTaskForm(taskType));
    ...
    const handleFormChange = (newFormData: Partial<PIKATask>) => {
