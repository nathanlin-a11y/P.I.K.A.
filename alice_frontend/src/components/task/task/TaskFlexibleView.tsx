...
import { PIKATask, TaskComponentProps, TaskType, PromptAgentTaskForm, CheckTaskForm, CodeExecutionLLMTaskForm, CodeGenerationLLMTaskForm, WorkflowForm, AgentWithFunctionsForm, AnyTaskForm } from '../../../utils/TaskTypes';
...
const TaskFlexibleView: React.FC<TaskComponentProps> = ({
    ...
    function assertTaskForm<T extends AnyTaskForm>(item: Partial<PIKATask>, taskType: TaskType): T {
