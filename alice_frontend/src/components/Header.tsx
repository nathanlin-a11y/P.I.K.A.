      ...
      <Toolbar>
        ...
        {isAuthenticated ? (
          <>
            ...
            <Tooltip title="Chat with PIKA">
              <IconButton color="inherit" onClick={() => handleNavigation('/chat-pika')}>
                <ChatIcon />
              </IconButton>
            </Tooltip>
            ...
            <Tooltip title="Configure PIKA Tools">
              <IconButton color="inherit" onClick={() => handleNavigation('/pika-tools')}>
                <BuildIcon />
              </IconButton>
            </Tooltip>
            <Box sx={{ flexGrow: 1 }} />
