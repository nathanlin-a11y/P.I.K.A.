...
import { PIKAModel, Prompt } from '../../utils/Types';
...
const EnhancedAgent: React.FC<EnhancedAgentProps> = (props) => {
  ...
  const renderAgent = (
    ...
    onChange: (newAgent: Partial<PIKAAgent>) => void,
  ...
  const renderViewMode = (
    ...
    const renderSingleItem = (agent: PIKAAgent) => {
      switch (props.mode) {
        case 'list':
        case 'shortList':
          return (
  ...
  const getModelName = (modelId: string | PIKAModel | null | undefined): string => {
