...
import { PIKAChat, PIKAAgent, TaskResponse, PIKATask, CreatePIKAChat } from '../../utils/types';
import { SIDEBAR_WIDTH, SIDEBAR_COLLAPSED_WIDTH } from '../../utils/constants';

interface SidebarProps {
  pastChats: PIKAChat[];
  handleSelectChat: (chatId: string) => Promise<void>;
  handleNewChatCreated: (chat: Partial<CreatePIKAChat>) => Promise<string | undefined>;
  agents: PIKAAgent[];
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const handleNewChat = async (chat: Partial<CreatePIKAChat>) => {
