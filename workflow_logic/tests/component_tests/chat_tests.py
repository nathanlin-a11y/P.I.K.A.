...
class ChatTests(TestModule):
    ...
    async def run_chat_without_functions_tests(self, chat: PIKAChat, api_manager: APIManager) -> Dict[str, str]:
        return {
    ...
    async def run_chat_with_functions_tests(self, chat: PIKAChat, api_manager: APIManager) -> Dict[str, str]:
        return {
    ...
    def test_function_registration(self, chat: PIKAChat) -> str:
    ...
    async def test_error_handling(self, chat: PIKAChat, api_manager: APIManager) -> str:
    ...
    async def test_multi_turn_conversation_with_functions(self, chat: PIKAChat, api_manager: APIManager) -> str:
        messages = [
