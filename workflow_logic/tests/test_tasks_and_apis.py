...
from workflow_logic.core import PIKAAgent, PIKAModel, PIKATask, Prompt
...
class _TestTaskEnvironment:
    def __init__(self):
        self.models: Dict[str, PIKAModel] = {}
        self.agents: Dict[str, PIKAAgent] = {}
        self.tasks: Dict[str, PIKATask] = {}
