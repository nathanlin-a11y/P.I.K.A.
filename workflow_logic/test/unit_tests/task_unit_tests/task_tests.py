...
from workflow_logic.core import FunctionParameters, ParameterDefinition, PIKATask, TaskResponse, DatabaseTaskResponse, ApiType
from pydantic import ValidationError

class ConcretePIKATask(PIKATask):
