...
from workflow_logic.core import FunctionParameters, ParameterDefinition, APIManager, API, PIKATask, Workflow, TaskResponse, StringOutput

class MockTask(PIKATask):
