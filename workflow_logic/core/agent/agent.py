...
from workflow_logic.core.model import ModelManager, PIKAModel, LLMConfig
...
class PIKAAgent(BaseModel):
    ...
    model_id: Optional[PIKAModel] = Field(default=None, description="The model object for the agent")
