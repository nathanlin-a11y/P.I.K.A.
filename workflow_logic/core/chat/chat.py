...
class PIKAChat(BaseModel):
    ...
    Attributes:
        ...
        executor (PIKAAgent): The agent responsible for executing code and functions.
    ...
    def get_autogen_agent(self, api_manager: APIManager) -> ConversableAgent:
        return self.pika_agent.get_autogen_agent(api_manager=api_manager, functions_list=self.functions_list(api_manager=api_manager)) 
