...
from workflow_logic.util.communication import MessageDict, TaskResponse
...
class CodeGenerationLLMTask(PromptAgentTask):
    ...
    Attributes:
        agent (PIKAAgent): The agent responsible for code generation.
...
class CodeExecutionLLMTask(PromptAgentTask):
    ...
    Attributes:
        agent (PIKAAgent): The agent responsible for code execution.
