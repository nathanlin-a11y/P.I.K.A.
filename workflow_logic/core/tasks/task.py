...
class PIKATask(BaseModel, ABC):
    ...
    tasks: Dict[str, "PIKATask"] = Field(default={}, description="A dictionary of task_id: task")
    ...
    agent_id: Optional[PIKAAgent] = Field(None, description="The agent that the task is associated with")
    execution_agent_id: Optional[PIKAAgent] = Field(None, description="The agent that the task is executed by")
