...
class APIManager(BaseModel):
    ...
    def retrieve_api_data(self, api_type: ApiType, model: Optional[PIKAModel] = None) -> Union[Dict[str, Any], LLMConfig]:
        """
    ...
    async def generate_response_with_api_engine(self, api_type: ApiType, model: Optional[PIKAModel] = None, **kwargs) -> Union[SearchOutput, MessageDict]:
        """
