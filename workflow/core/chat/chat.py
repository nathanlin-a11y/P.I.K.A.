...
from workflow.core.tasks import PIKATask, RetrievalTask
...
class PIKAChat(BaseDataStructure):
    ...
    agent_tools: Optional[List[PIKATask]] = Field([], description="List of tools to be registered with the agent")
    retrieval_tools: Optional[List[PIKATask]] = Field(None, description="Optional retrieval task for accessing data cluster")
