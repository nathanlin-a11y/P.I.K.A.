...
from workflow.core.api.engines.__init__new import ApiEngineMap
from workflow.core.data_structures.api_utils_new import ApiType, ApiName
...
class APITask(PIKATask):
    ...
    It inherits from PIKATask to integrate with the node-based execution framework.
