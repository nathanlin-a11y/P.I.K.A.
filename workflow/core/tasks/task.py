...
from workflow.core.data_structures.task_response import NodeResponse, TaskResponse
...
class PIKATask(BaseModel, ABC):
    ...
    tasks: Dict[str, "PIKATask"] = Field(default_factory=dict, description="A dictionary of task_id: task")
    ...
    agent: Optional[PIKAAgent] = Field(default=None, description="The agent that the task is associated with, if any")
