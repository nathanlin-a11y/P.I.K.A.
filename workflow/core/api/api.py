...
from workflow.core.data_structures import ApiType, ApiName, ModelConfig, ModelApis, PIKAModel, BaseDataStructure
...
class API(BaseDataStructure):
    ...
    Attributes:
        ...
        default_model (Optional[PIKAModel]): Default model for AI services
    ...
    name: str
    is_active: bool = True
    default_model: Optional[PIKAModel] = None # TODO: Add validation to match api_name and model_type
    ...
    def create_model_config(self, model: Optional[PIKAModel] = None) -> ModelConfig:
    ...
    def get_api_data(self, model: Optional[PIKAModel] = None) -> Union[Dict[str, Any], ModelConfig]:
        """
