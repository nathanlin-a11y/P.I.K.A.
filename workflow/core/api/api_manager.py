...
from workflow.core.data_structures import References, ApiType, ApiName, ModelConfig, ModelApis, PIKAModel
...
class APIManager(BaseModel):
    ...
    def get_api_by_type(self, api_type: ApiType, model: Optional[PIKAModel] = None) -> Optional[API]:
        """
        ...
        Args:
            ...
            model (Optional[PIKAModel]): The model to consider for LLM APIs.
    ...
    def _retrieve_model_api(self, api_type: ApiType = ApiType.LLM_MODEL, model: Optional[PIKAModel] = None) -> Optional[API]:
        """
        ...
        Args:
            model (Optional[PIKAModel]): The model to match against.
    ...
    def retrieve_api_data(self, api_type: ApiType, model: Optional[PIKAModel] = None) -> Union[Dict[str, Any], ModelConfig]:
        """
    ...
    async def generate_response_with_api_engine(self, api_type: ApiType, model: Optional[PIKAModel] = None, **kwargs) -> References:
        """
        ...
        Args:
            ...
            model (Optional[PIKAModel]): The preferred model to use, if applicable.
