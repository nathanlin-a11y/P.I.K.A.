...
from workflow.core.data_structures import References, ApiType, ApiName, ModelConfig, PIKAModel
...
class APIManager(BaseModel):
    ...
    def retrieve_api_data(self, api_type: ApiType, api_name: Optional[ApiName] = None, model: Optional[PIKAModel] = None) -> Union[Dict[str, Any], ModelConfig]:
        """
    ...
    async def generate_response_with_api_engine(self, api_type: ApiType, api_name: Optional[ApiName] = None, model: Optional[PIKAModel] = None, **kwargs) -> References:
        """
