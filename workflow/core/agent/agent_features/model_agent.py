...
from workflow.core.data_structures import (
    ...
    FileContentReference, EmbeddingChunk, PIKAModel, Prompt, RoleTypes, MessageGenerators,
...
class ModelAgent(BaseModel):
    ...
    async def generate_speech(self, api_manager: APIManager, input: str, voice: str, speed: float = 1.0) -> References:
        """
