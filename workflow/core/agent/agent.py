...
from workflow.core.data_structures import (
    TaskResponse, FileReference, ContentType, MessageDict, ApiType, ModelType, FileType, References, FileContentReference, EmbeddingChunk, PIKAModel, Prompt, BaseDataStructure
    )
