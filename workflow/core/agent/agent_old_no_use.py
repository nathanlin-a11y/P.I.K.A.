...
from workflow.core.data_structures import (
    ...
    FileContentReference, EmbeddingChunk, PIKAModel, Prompt, BaseDataStructure, RoleTypes, MessageGenerators,
...
class PIKAAgent(BaseDataStructure):
    ...
    PIKAAgent serves as a unified interface for various AI model interactions, handling everything from
    ...
    Attributes:
        ...
        models (Dict[ModelType, Optional[PIKAModel]]): Available models for different tasks
    ...
    models: Dict[ModelType, Optional[PIKAModel]] = Field(
        default={
            ModelType.CHAT: None,
    ...
    @property
    def llm_model(self) -> PIKAModel:
        return self.models[ModelType.CHAT] or self.models[ModelType.INSTRUCT]
    
    def model_dump(self, *args, **kwargs):
        """
        Serializes the PIKAAgent instance to a dictionary, handling:
        ...
        """
        LOGGER.debug(f"PIKAAgent.model_dump called")
        ...
        try:
            ...
            LOGGER.debug(f"PIKAAgent base dump succeeded")
        except TypeError as e:
            LOGGER.error(f"TypeError in PIKAAgent model_dump: {str(e)}")
