...
from workflow.core import PIKAChat, PIKATask, API, MessageDict, FileReference, FileContentReference, ChatThread
...
class BackendAPI(BaseModel):
    ...
    Methods:
        ...
        get_chat(chat_id: str) -> PIKAChat: Retrieves chat.
    ...
    async def get_task(self, task_id: str) -> PIKATask:
    ...
    async def get_chat(self, chat_id: str) -> PIKAChat:
    ...
    async def get_chat_thread(self, thread_id: str) -> PIKAChat:
    ...
    async def store_chat_message(self, chat_id: str, thread_id: str, message: MessageDict) -> PIKAChat:
