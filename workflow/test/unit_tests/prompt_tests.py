import pytest
from workflow.core.data_structures import FunctionParameters, ParameterDefinition, Prompt
...
def test_prompt_format():
    ...
    result = prompt.format_prompt(name="PIKA")
    assert result == "Hello, PIKA!"
...
def test_prompt_partial():
    ...
    partial_prompt = prompt.partial(first_name="PIKA")
    assert partial_prompt.content == "Hello, PIKA {{last_name}}!"
...
def test_prompt_with_optional_parameter():
    ...
    assert prompt.format_prompt(name="PIKA", age=30) == "Hello, PIKA! You are 30 years old."
...
def test_prompt_with_default_values():
    ...
    assert prompt.format_prompt(name="PIKA") == "Hello, PIKA! Welcome to New York."
