        ...
        >
            ...
            >
                ...
                <p className="text-sm text-neutral-500">
                    Hi! I'm PIKA. How can I help you today? I'm here to assist with your tasks and questions.
                </p>
            </motion.div>
            <motion.div
                variants={variants}
            ...
            >
                <p className="text-sm text-neutral-500">Help me, PIKA-wan: You're my only hope.</p>
