    ...
    useEffect(() => {
        const populateItems = async () => {
            ...
            const [
                ...
                userObject.default_chat_config?.pika_agent ?
                    fetchItem('agents', userObject.default_chat_config.pika_agent) : undefined,
            ...
            setPopulatedItems({
                agent: agent as PIKAAgent,
                agentTools: agentTools as PIKATask[],
                retrievalTools: retrievalTools as PIKATask[],
