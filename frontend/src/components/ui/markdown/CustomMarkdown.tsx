...
import { PIKADocumentBlockComponent } from './custom_block/PIKADocumentBlock';
...
const CustomMarkdown: React.FC<CustomMarkdownProps> = ({ className, children }) => {
  ...
  const components: Components = {
    ...
    div: ({ node, className, children, ...props }) => {
      ...
      } else if (className === 'custom-block custom-block-pikaDocument') {
        return <PIKADocumentBlockComponent node={node} {...props} />;
      } else {
        return (
  ...
  const customBlockConfig: BlockDefinitions = {
    ...
    pikaDocument: {
      classes: 'custom-block-pikaDocument',
      containerElement: 'div',
    },
  };
