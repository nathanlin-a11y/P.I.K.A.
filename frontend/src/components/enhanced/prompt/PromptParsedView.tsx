...
import PIKAMarkdown, { RoleType } from '../../ui/markdown/pika_markdown/PIKAMarkdown';
        ...
        <Box className="space-y-4">
          ...
          <Box className="mt-6">
            ...
            <Card variant="outlined" className="p-4 bg-gray-50">
              {systemPrompt && renderedSystemContent && (
                <Box className="mb-1">
                  <PIKAMarkdown role={RoleType.SYSTEM}>
                    {renderedSystemContent}
                  </PIKAMarkdown>
                </Box>
              )}
              <PIKAMarkdown role={RoleType.USER}>
                {renderedContent}
              </PIKAMarkdown>
            </Card>
          </Box>
          ...
          {systemPrompt && (
            <Accordion>
              ...
              <AccordionDetails>
                <PIKAMarkdown showCopyButton role={RoleType.SYSTEM}>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <PIKAMarkdown showCopyButton role={RoleType.USER}>
                {prompt.content}
              </PIKAMarkdown>
            </AccordionDetails>
          </Accordion>
