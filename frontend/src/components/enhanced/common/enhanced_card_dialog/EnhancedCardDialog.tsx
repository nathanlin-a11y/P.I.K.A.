...
const EnhancedCardDialog: React.FC = () => {
  ...
  const renderDialogContent = () => {
    ...
    const handleProps = {
      handleAgentClick: (id: string, item?: PIKAAgent) => selectCardItem('Agent', id, item),
      handleTaskClick: (id: string, item?: PIKATask) => selectCardItem('Task', id, item),
      handleModelClick: (id: string, item?: PIKAModel) => selectCardItem('Model', id, item),
