        ...
        <DialogContent>
          ...
          <Box className="mb-6 space-y-4">
            <Typography variant="body1">
              P.I.K.A. organizes operations into distinct task types. Each task type is designed for specific use cases and provides built-in functionality.
            </Typography>
                ...
                <BentoGridItem
                  ...
                  description={
                    <Box className="space-y-4">
                      <PIKAMarkdown>{taskInfo.description}</PIKAMarkdown>
                      {isExpanded && (
                        <Box className="mt-4">
                  ...
                  className={`md:col-span-${currentTaskType ? '3' : '2'}`}
