...
import { PIKATask, getDefaultTaskForm, PopulatedTask, TaskComponentProps, TaskType } from '../../../../types/TaskTypes';
...
const TaskFlexibleView: React.FC<TaskComponentProps> = ({
    ...
    const handleFieldChange = useCallback((field: keyof PIKATask, value: any) => {
        if (field === 'task_type') {
