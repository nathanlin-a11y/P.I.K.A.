...
import { PIKAModel, getDefaultModelForm, ModelComponentProps, ModelType } from '../../../../types/ModelTypes';
...
const ModelFlexibleView: React.FC<ModelComponentProps> = ({
    ...
    const handleFieldChange = useCallback((field: keyof PIKAModel, value: any) => {
