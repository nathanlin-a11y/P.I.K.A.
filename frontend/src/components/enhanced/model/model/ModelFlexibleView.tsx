...
import { PIKAModel, getDefaultModelForm, ModelComponentProps, ModelType, ModelConfig, ChatTemplateTokens, ModelCosts } from '../../../../types/ModelTypes';
...
const ModelFlexibleView: React.FC<ModelComponentProps> = ({
    ...
    const [form, setForm] = useState<Partial<PIKAModel>>(() => item || getDefaultModelForm());
    ...
    const handleBaseFieldChange = useCallback((field: keyof PIKAModel, value: any) => {
