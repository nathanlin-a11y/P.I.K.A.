...
interface ChatContextType {
    ...
    pastChats: (PIKAChat | PopulatedPIKAChat)[];
    ...
    setPastChats: React.Dispatch<React.SetStateAction<(PIKAChat | PopulatedPIKAChat)[]>>;
...
export const ChatProvider: React.FC<ChatProviderProps> = ({ children }) => {
    ...
    const [pastChats, setPastChats] = useState<(PIKAChat | PopulatedPIKAChat)[]>([]);
    ...
    const addTaskToChat = async (taskId: string) => {
        ...
        try {
            const task = await fetchItem("tasks", taskId) as PIKATask;
