...
export interface PIKATask extends BaseDatabaseObject {
  task_name: string;
...
export interface PopulatedTask extends Omit<PIKATask, 'data_cluster' | 'tasks'> {
...
export interface TaskComponentProps extends EnhancedComponentProps<PIKATask | PopulatedTask> {
