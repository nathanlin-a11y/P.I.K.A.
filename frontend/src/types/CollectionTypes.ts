...
import { PIKATask, PopulatedTask } from './TaskTypes';
...
export type CollectionElement = PIKAAgent | PIKAChat | PIKAModel | PIKATask | Prompt | TaskResponse | User | ParameterDefinition | API | User | FileReference | MessageType | UserInteraction | UserCheckpoint | DataCluster | EmbeddingChunk | ToolCall | CodeExecution | APIConfig | EntityReference | ChatThread;
export type CollectionPopulatedElement = PIKAAgent | PopulatedPIKAChat | PIKAModel | PopulatedTask | Prompt | PopulatedTaskResponse | User | ParameterDefinition | API | User | PopulatedFileReference | PopulatedMessage | PopulatedUserInteraction | UserCheckpoint | PopulatedDataCluster | EmbeddingChunk | PopulatedToolCall | PopulatedCodeExecution | APIConfig | PopulatedEntityReference | PopulatedChatThread;
...
export interface MessageCreationMetadata {
    ...
    prompt_similarity_history?: Record<string, any>[];
}
