  ...
  try {
    if (this.default_chat_config) {
      ...
      if (this.default_chat_config.pika_agent) {
        this.default_chat_config.pika_agent = getObjectId(
          this.default_chat_config.pika_agent, 
          { ...context, field: 'default_chat_config.pika_agent' }
        );
      }
...
function ensureObjectIdForUpdate(
  ...
  try {
    ...
    if (update.default_chat_config.pika_agent) {
      update.default_chat_config.pika_agent = getObjectId(
        update.default_chat_config.pika_agent,
        { ...context, field: 'default_chat_config.pika_agent' }
      );
    }
